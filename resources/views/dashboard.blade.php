    ...
    <div class="owl-carousel counter-carousel owl-theme">
            ...
            <div class="card border-0 zoom-in bg-light-primary shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{asset('dist/images/svgs/icon-user-male.svg')}}" width="50" height="50" class="mb-3"
                            alt="" />
        ...
        <div class="item">
            <div class="card border-0 zoom-in bg-light-warning shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{asset('dist/images/svgs/icon-briefcase.svg')}}" width="50" height="50" class="mb-3"
                            alt="" />
        ...
        <div class="item">
            <div class="card border-0 zoom-in bg-light-danger shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{asset('dist/images/svgs/icon-favorites.svg')}}" width="50" height="50" class="mb-3"
                            alt="" />
